  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.titleContainer}>
        ...
        <ThemedText type="title">Dog Owner One</ThemedText>
        <Image source={require('@/assets/images/profilephoto.jpg')} style={styles.profilePhotoImage} />
        <ThemedText>I am an example user on this platform. I have sold x amount of products and y amount of feedback has been given to me!</ThemedText>
